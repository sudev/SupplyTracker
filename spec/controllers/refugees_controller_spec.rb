...
RSpec.describe RefugeesController, type: :controller do
  ...
  # Refugee. As you add validations to Refugee, be sure to
  ...
  # RefugeesController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "returns a success response" do
      Refugee.create! valid_attributes
  ...
  describe "DELETE #destroy" do
    it "destroys the requested refugee" do
      refugee = Refugee.create! valid_attributes
      expect {
        delete :destroy, params: {id: refugee.to_param}, session: valid_session
      }.to change(Refugee, :count).by(-1)
    end

    it "redirects to the refugees list" do
      refugee = Refugee.create! valid_attributes
      delete :destroy, params: {id: refugee.to_param}, session: valid_session
      expect(response).to redirect_to(refugees_url)
    end
  end
